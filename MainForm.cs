        ...
        void ParseImportedFile()
        {
			while (device.Opened) {
				...
				while ((packet = device.GetNextPacket()) != null) {
					...
					if ((tcpPacket.SourcePort < Config.Instance.LowPort || tcpPacket.SourcePort > Config.Instance.HighPort || tcpPacket.SourcePort == 9301) &&
                        (tcpPacket.DestinationPort < Config.Instance.LowPort || tcpPacket.DestinationPort > Config.Instance.HighPort || tcpPacket.DestinationPort == 9301))
						continue;
